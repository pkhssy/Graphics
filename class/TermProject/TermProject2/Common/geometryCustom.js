...
var size;
//modified by Yoon(Start)
if (!s || (40<=s && s<50)) size = 0.5;
//modified by Yoon(End)
else size = s/2;
...
if(s == 42){
  cubeVertexColors = [
    [ 0.36, 0.32, 0.16, 1.0 ],  // red
    [ 0.36, 0.32, 0.16, 1.0 ],  // yellow
    [ 0.36, 0.32, 0.16, 1.0 ],  // green
    [ 0.36, 0.32, 0.16, 1.0 ],  // blue
    [ 0.36, 0.32, 0.16, 1.0 ],  // magenta
    [ 0.36, 0.32, 0.16, 1.0 ],  // cyan
    [ 0.36, 0.32, 0.16, 1.0 ],   // white
    [ 0.36, 0.32, 0.16, 1.0 ]  // black
];
}
//
//modified by Yoon(End)
...
function cylinder(numSlices, numStacks, caps, sideC, topC, bottomC) {
...
//modified by Yoon(Start)
function Y_custom_cylinder_colors(passwordOfCustomYoon){
  if(passwordOfCustomYoon == 40){
    sideColor = [0.9,0.9,0.9,1.0];
    topColor = [0.9,0.9,0.9,1.0];
    bottomColor = [0.9,0.9,0.9,1.0];
  }
  else if(passwordOfCustomYoon == 41){
    sideColor = [0.7,0.7,0.7,1.0];
    topColor = [0.7,0.7,0.7,1.0];
    bottomColor = [0.7,0.7,0.7,1.0];
  }
  else if(passwordOfCustomYoon == 42){
    sideColor = [1,1,0.0,0.2];
    topColor = [1,1,0.0,0.2];
    bottomColor = [1,1,0.0,0.2];
  }
}
if(40<=numSlices && numSlices<50){
  Y_custom_cylinder_colors(numSlices);
}
//modified by Yoon(End)
